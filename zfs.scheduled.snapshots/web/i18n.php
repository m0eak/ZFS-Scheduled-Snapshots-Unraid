...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'snapshots.all_snapshots_notice' => 'This page shows all snapshots under the selected dataset. The plugin only manages autosnap_* and manual_* snapshots by default. External snapshots are displayed read-only and are not affected by pruning.',
        ...
        'zh-CN' => [
            ...
            'snapshots.all_snapshots_notice' => '此页面会显示该数据集下的全部快照。插件仅默认管理 autosnap_* 和 manual_* 快照，外部快照仅展示，不参与自动清理。',
