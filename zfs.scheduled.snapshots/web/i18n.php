...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'settings.theme.description' => 'The WebUI appearance follows the host Unraid theme (including Dynamix night mode). No separate appearance setting is used.',
        ...
        'zh-CN' => [
            ...
            'settings.theme.description' => 'WebUI 外观跟随 Unraid 宿主主题（含夜间模式），不再单独设置。',
