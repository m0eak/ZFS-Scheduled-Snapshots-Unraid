...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'snapshots.all_snapshots_notice' => 'This page shows all snapshots under the selected dataset. Manual actions can operate on all visible snapshots, while automatic pruning only affects autosnap_* snapshots.',
        ...
        'zh-CN' => [
            ...
            'snapshots.all_snapshots_notice' => '此页面会显示该数据集下的全部快照。手动操作可作用于所有可见快照，自动清理仍仅影响 autosnap_* 快照。',
