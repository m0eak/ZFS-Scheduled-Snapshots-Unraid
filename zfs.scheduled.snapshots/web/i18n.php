...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'snapshots.hold_dialog_message' => 'This will add the autosnap hold tag. The snapshot cannot be deleted until protection is released.',
            'snapshots.hold_dialog_confirm' => 'Set read-only',
            'snapshots.hold_success_detail' => 'Snapshot hold tag autosnap was added.',
        ...
        'zh-CN' => [
            ...
            'snapshots.hold_dialog_message' => '将为此快照添加 autosnap hold 标签。添加后，删除前需要先释放保护。',
            'snapshots.hold_dialog_confirm' => '设为只读',
            'snapshots.hold_success_detail' => '已为快照添加 autosnap hold 标签。',
