...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'datasets.create.description' => 'Create a new ZFS dataset under an existing parent dataset.',
            'datasets.create.name' => 'Dataset name',
            'datasets.create.action' => 'Create dataset',
            'datasets.create.name_required' => 'Dataset name is required',
        ...
        'zh-CN' => [
            ...
            'datasets.create.description' => '在已有父数据集下创建新的 ZFS 数据集。',
            'datasets.create.name' => '数据集名称',
            'datasets.create.action' => '创建数据集',
            'datasets.create.name_required' => '请输入数据集名称',
