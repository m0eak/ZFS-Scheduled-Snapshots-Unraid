...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'settings.theme.inherit.title' => 'Theme',
            'settings.theme.inherit.description' => 'This WebUI follows the host Unraid theme (including night mode). No separate appearance settings are needed.',
        ...
        'zh-CN' => [
            ...
            'settings.theme.inherit.title' => '主题',
            'settings.theme.inherit.description' => '本界面跟随宿主机 Unraid 主题（含夜间模式），无需单独的外观设置。',
