...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'settings.theme.inherit.title' => 'Host theme',
            'settings.theme.inherit.description' => 'The WebUI defaults to your browser light/dark preference, but you can pin Light or Dark per browser. The active Unraid host theme is reported for reference only.',
        ...
        'zh-CN' => [
            ...
            'settings.theme.inherit.title' => '宿主主题',
            'settings.theme.inherit.description' => 'WebUI 默认跟随浏览器的浅色/深色偏好，也可按浏览器固定浅色或深色。当前生效的 Unraid 宿主主题仅作参考展示。',
