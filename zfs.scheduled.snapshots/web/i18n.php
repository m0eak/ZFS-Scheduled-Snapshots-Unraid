...
function zss_translations(): array
{
    return [
        'en' => [
            ...
            'snapshots.all_snapshots_notice' => 'This page shows all snapshots under the selected dataset. Plugin-managed snapshots can be held, released, deleted, or rolled back. External snapshots are shown read-only.',
        ...
        'zh-CN' => [
            ...
            'snapshots.all_snapshots_notice' => '此页面会显示该数据集下的全部快照。只有插件管理的快照支持设置只读、释放、删除或回滚。外部快照仅只读展示。',
