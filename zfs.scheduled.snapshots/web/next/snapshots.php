...
<div class="zss-page-actions">
    <?php if ($dataset): ?>
        <a class="zss-btn zss-btn-secondary" href="<?php echo htmlspecialchars(withLang('snapshots.php')); ?>">← <?php echo htmlspecialchars(zss_t('snapshots.back_all')); ?></a>
    ...
    <?php else: ?>
        <a class="zss-btn zss-btn-secondary" href="<?php echo htmlspecialchars(withLang('../snapshots-list.php')); ?>"><?php echo htmlspecialchars(zss_t('nav.snapshots')); ?> · Classic UI</a>
    <?php endif; ?>
</div>
